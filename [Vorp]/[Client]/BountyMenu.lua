...
if (((Plugins.BountyHunter) and not (_StartError_) and (Framework.Vorp) and (BountyHunter.NUI.Theme.Red) and not (Framework.RedEmRP))) then
  ...
  function WarBountyMenu.CreateMenu(id, title, subTitle)
    -- Default settings
    menus[id] = { }
    ...
    if BountyHunter.NUI.Position.Right then
      menus[id].x = 0.75
      menus[id].y = 0.10
    elseif BountyHunter.NUI.Position.Left then
      menus[id].x = 0.03
      menus[id].y = 0.10
    elseif BountyHunter.NUI.Position.Center then
      menus[id].x = 0.395
      menus[id].y = 0.30
    end
  ...
  function WarBountyMenu.CreateSubMenu(id, parent, subTitle)
    if menus[parent] then
      WarBountyMenu.CreateMenu(id, menus[parent].title)
  ...
  function WarBountyMenu.CurrentMenu()
    return currentMenu
  end


  function WarBountyMenu.OpenMenu(id)
    if id and menus[id] then
  ...
  function WarBountyMenu.IsMenuOpened(id)
    return isMenuVisible(id)
  end


  function WarBountyMenu.IsAnyMenuOpened()
  ...
  function WarBountyMenu.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
  ...
  function WarBountyMenu.CloseMenu()
    if menus[currentMenu] then
  ...
  function WarBountyMenu.Button(text, subText, descText)
  ...
  function WarBountyMenu.MenuButton(text, id)
    if menus[id] then
      if WarBountyMenu.Button(text) then
        setMenuVisible(currentMenu, false)
  ...
  function WarBountyMenu.CheckBox(text, checked, callback)
    if WarBountyMenu.Button(text, checked and 'On' or 'Off') then
      checked = not checked
  ...
  function WarBountyMenu.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if WarBountyMenu.Button(text, selectedItem) then
  ...
  function WarBountyMenu.Display()
  ...
  function WarBountyMenu.SetMenuWidth(id, width)
    setMenuProperty(id, 'width', width)
  end


  function WarBountyMenu.SetMenuX(id, x)
    setMenuProperty(id, 'x', x)
  end


  function WarBountyMenu.SetMenuY(id, y)
    setMenuProperty(id, 'y', y)
  end


  function WarBountyMenu.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, 'maxOptionCount', count)
  end


  function WarBountyMenu.SetTitle(id, title)
    setMenuProperty(id, 'title', title)
  end


  function WarBountyMenu.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, 'titleColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleColor.a })
  end


  function WarBountyMenu.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, 'titleBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].titleBackgroundColor.a })
  end


  function WarBountyMenu.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, 'titleBackgroundSprite', { dict = textureDict, name = textureName })
  end


  function WarBountyMenu.SetSubTitle(id, text)
    setMenuProperty(id, 'subTitle', string.upper(text))
  end


  function WarBountyMenu.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, 'menuBackgroundColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuBackgroundColor.a })
  end


  function WarBountyMenu.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, 'menuTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuTextColor.a })
  end

  function WarBountyMenu.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, 'menuSubTextColor', { ['r'] = r, ['g'] = g, ['b'] = b, ['a'] = a or menus[id].menuSubTextColor.a })
  end

  function WarBountyMenu.SetMenuFocusColor(id, r, g, b, a)
...
if Plugins.BountyHunter and BountyHunter.NUI.Theme.Dark then
  ...
  function WarBountyMenu.CreateMenu(id, title)
    -- Default settings
    menus[id] = { }
    menus[id].title = title or ''
